...
```
Remove-RAVendorInvitation [-Authn] <SecureString> [-InvitationId] <String> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### Example 1
```
PS C:\> Remove-RAVendorInvitation -Authn $auth -InvitationId 123hjk1j3h1khg3h4jgj
```
