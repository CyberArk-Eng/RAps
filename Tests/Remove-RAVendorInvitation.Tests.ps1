Describe "Remove-RAVendorInvitation" {
    BeforeAll {
    ...
    Context "Verifying parameters" {
        ...
        It "<Parameter> is mandatory" -TestCases $mandatoryParameter {
            param($Parameter)
            $functionMeta = Get-Command -Name Remove-RAVendorInvitation
    ...
    Context "Verify the output" {
        ...
        It "Remove Alero vendor invitation" {
            ...
            $invitation = Remove-RAVendorInvitation -Authn $auth -InvitationId $vendor
