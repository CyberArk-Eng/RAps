Describe "Get-RAGroups" {
    ...
    Context "Verifying parameters" {
        ...
        It "<Parameter> is mandatory for ParameterSet <ParameterSet>" -TestCases $mandatoryParameter {
            ...
            $functionMeta = Get-Command -Name Get-RAGroups
