#
# Module manifest for module 'RAps'
#
# Generated on: 24/02/2024
#

@{

    # Script module or binary module file associated with this manifest.
    RootModule        = 'RAps.psm1'
    ...
    FunctionsToExport = @(
        ...
        'Add-UserToTeam',
        'Remove-UserFromTeam',
        'Add-VendorManagerPermission',
        'Edit-VendorManagerPermission'
    )
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags       = @('CyberArk', 'Alero', 'RemoteAccess','VendorPAM')

            # A URL to the license for this module.
            LicenseUri = 'https://github.com/CyberArk-Eng/RAps/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/CyberArk-Eng/RAps'
